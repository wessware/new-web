...
$myemail = "admin@setkenya.org"; // Replace with your email
...
$msg = wordwrap($msg,70);
mail($myemail,"New Form Feedback",$msg);
mail($email,"Thank you for your form feedback",$msg);
echo 'Thank you for your Feedback. <a href="index.html">Click here to return to our homepage.</a>';
